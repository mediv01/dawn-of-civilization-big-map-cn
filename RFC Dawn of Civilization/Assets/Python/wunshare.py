...
def onSaveGame():
    ...
    f = open(CVGAMECORE_LOG_PATH + "wunshare.csv", "a")
    f.write("iGameTurn, ")
    f.write("iTotalTime, ")
...
# 每回合重新读取文本
# if gcgame.getCurrentLanguage() == 5: # 中文
#	gcgame.setCurrentLanguage(0)
#	gcgame.setCurrentLanguage(5)
