...
class PyPlayer:
    ...
    def __init__(self, iPlayer):
        ...
        if iPlayer:
            self.player = gcgetPlayer(iPlayer)
        else:
            self.player = gcgetPlayer(0)
    ...
    def getTeam(self):
        ...
        return gcgetTeam(self.getTeamID())
    ...
    def getPlotList(self):
        ...
        for iIndex in self.getPlotIDList():
            lPlots.append(GlobalCyMap.plotByIndex(iIndex))
        return lPlots
    ...
    def getPlotIDList(self):
        ...
        for i in xrange(GlobalCyMap.numPlots()):
            if (GlobalCyMap.sPlotByIndex(i).getOwner() == self.getID()):
                lPlotIDs.append(i)
        return lPlotIDs
...
class PyCity:
    ...
    def __init__(self, iPlayerID, iCityID):
        self.player = gcgetPlayer(iPlayerID)
...
class PyGame:
    ...
    def getCivPlayerList(self):
        ...
        for i in range(gc.getMAX_CIV_PLAYERS()):
            if (gcgetPlayer(i).isAlive()):
                loopPlayer = PyPlayer(gcgetPlayer(i).getID())
    ...
    def getActivePlayer(self):
        return gcgetPlayer(self.game.getActivePlayer())
...
class PyInfo:
    ...
    class BonusInfo:
        ...
        def getButton(self):
            return GlobalCyArtFileMgr.getBonusArtInfo(self.info.getArtDefineTag()).getButton()
    ...
    class UnitInfo:
        ...
        def getButton(self):
            ...
            return GlobalCyArtFileMgr.getUnitArtInfo(self.info.getArtDefineTag(0)).getButton()
    ...
    class ImprovementInfo:
        ...
        def getButton(self):
            return GlobalCyArtFileMgr.getImprovementArtInfo(self.info.getArtDefineTag()).getButton()
    ...
    class BuildingInfo:
        ...
        def getButton(self):
            return GlobalCyArtFileMgr.getBuildingArtInfo(self.info.getArtDefineTag()).getButton()
