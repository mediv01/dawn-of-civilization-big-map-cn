...
#	GlobalCyInterface.addImmediateMessage(message.decode("latin-1"),"")
# else:
...
def logToFile(message):
    ...
    message = CvUtil.convertToStr(message)

    if (wunshare_test.BugUtilOutput):  # wunshare: 提升速度
...
def isNoEspionage():
    ...
    """
    try:
        return gcgame.isOption(GameOptionTypes.GAMEOPTION_NO_ESPIONAGE)
    except:
        return False
