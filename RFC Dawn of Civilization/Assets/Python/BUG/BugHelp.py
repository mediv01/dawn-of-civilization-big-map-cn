...
def launch(argsList=None):
    ...
    if BugPath.isMac():
        ...
        url = "http://civ4bug.sourceforge.net/BUGModHelp/%s/index.htm" % sLang[GlobalCyGame.getCurrentLanguage()]
        try:
            import webbrowser
            showLaunchMessage()
        ...
        name = "BUG Mod Help-%s.chm" % (sLang[GlobalCyGame.getCurrentLanguage()])
