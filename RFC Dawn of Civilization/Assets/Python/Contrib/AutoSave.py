...
def getSaveFileName(pathName):
    if pathName:
        ...
        if not MapFinder.isActive() and options.isUsePlayerName():
            ...
            turnYear = GlobalCyGameTextMgr.getTimeStr(utils.getGameTurn(), False)
            ...
            turnYear = GlobalCyGameTextMgr.getTimeStr(game.getGameTurn(), False)
...
def saveGameStart():
    ...
    """
    if not GlobalCyGame.isGameMultiPlayer() and options.isCreateStartSave() and not MapFinder.isActive():
        saveGame()
...
def saveGameEnd():
    ...
    """
    if not GlobalCyGame.isGameMultiPlayer() and options.isCreateEndSave() and not MapFinder.isActive():
        saveGame()
...
def saveGameExit():
    ...
    """
    if not GlobalCyGame.isGameMultiPlayer() and options.isCreateExitSave() and not MapFinder.isActive():
        saveGame()
