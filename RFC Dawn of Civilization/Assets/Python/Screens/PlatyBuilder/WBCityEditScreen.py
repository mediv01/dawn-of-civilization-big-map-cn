...
class WBCityEditScreen:
    ...
    def interfaceScreen(self, pCityX):
        ...
        screen.setText("WBCityEditExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
                       FontTypes.TITLE_FONT, WidgetTypes.WIDGET_CLOSE_SCREEN, -1, -1)
        sText = "<font=3b>%s, X: %d, Y: %d</font>" % (GlobalCyTranslator.getText("TXT_KEY_WB_LATITUDE", (pCity.plot().getLatitude(),)), pCity.getX(), pCity.getY())

        sText = u"<font=3b>%s ID: %d, %s: %d</font>" % (GlobalCyTranslator.getText("TXT_KEY_WB_CITY", ()), pCity.getID(), GlobalCyTranslator.getText("TXT_KEY_WB_AREA_ID", ()), pPlot.getArea())
        ...
        for i in xrange(gc.getMAX_PLAYERS()):
            ...
            if pPlayerX.isEverAlive():
                sText = utils.getLeaderNameOrCivName(i)
        ...
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_WB_MOVE_CITY", ()), 1, 1, False)
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_WB_DUPLICATE_CITY", ()), 2, 2, False)
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_WB_MOVE_CITY", ()) + " + " + GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()), 3, 3, False)
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_WB_DUPLICATE_CITY", ()) + " + " + GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()), 4, 4, False)
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_WB_RAZE_CITY", ()), 5, 5, False)
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_DATA", ()), 0, 0, True)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_DATA2", ()), 1, 1, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_BUILDING", ()), 2, 2, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_PLAYER_DATA", ()), 3, 3, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_TEAM_DATA", ()), 4, 4, False)
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()) + " + " + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_CITIES", ()), 5, 5, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_PLOT_DATA", ()), 6, 6, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_CONCEPT_EVENTS", ()), 7, 7, False)
    ...
    def placeCityTable(self):
        ...
        for (loopCity, iPlayerX, sColor) in self.lCities:
            ...
            iLeader = gcgetPlayer(iPlayerX).getLeaderType()
    ...
    def placeStats(self):
        ...
        sText = u"<font=3>%s %s/%s%c</font>" % (
            GlobalCyTranslator.getText("TXT_KEY_WB_CULTURE", ()), CvPlatyBuilderScreen.CvWorldBuilderScreen().addComma(pCity.getCulture(iPlayer)), CvPlatyBuilderScreen.CvWorldBuilderScreen().addComma(pCity.getCultureThreshold()),
        ...
        sText = u"<font=3>%s: %d/%d%c</font>" % (GlobalCyTranslator.getText("TXT_KEY_CONCEPT_FOOD", ()), pCity.getFood(), pCity.growthThreshold(), gc.getYieldInfo(YieldTypes.YIELD_FOOD).getChar())
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_POPULATION", ()) + " " + str(pCity.getPopulation()) + GlobalCyTranslator.getText("[ICON_ANGRYPOP]", ()) + "</font>"
        ...
        iY += 30
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_DEFENSE", (pCity.getDefenseModifier(False),)) + "</font>"
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_DAMAGE", ()) + ": " + str(pCity.getDefenseDamage()) + "</font>"
        ...
        sText = u"<font=3>%s: %d%s</font>" % (GlobalCyTranslator.getText("TXT_KEY_CONCEPT_TRADE", ()), pCity.getTradeRoutes(), GlobalCyTranslator.getText("[ICON_TRADE]", ()))
        ...
        sText = "<font=3>%s: %d%s, %d%s</font>" % (GlobalCyTranslator.getText("TXT_KEY_CONCEPT_HAPPINESS", ()), pCity.happyLevel(), GlobalCyTranslator.getText("[ICON_HAPPY]", ()), pCity.unhappyLevel(0), GlobalCyTranslator.getText("[ICON_UNHAPPY]", ()))
        ...
        sText = "<font=3>%s: %d%s, %d%s</font>" % (
            GlobalCyTranslator.getText("TXT_KEY_CONCEPT_HEALTH", ()), pCity.goodHealth(), GlobalCyTranslator.getText("[ICON_HEALTHY]", ()), pCity.badHealth(False), GlobalCyTranslator.getText("[ICON_UNHEALTHY]", ()))
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_RESISTANCE", ()) + ": " + str(pCity.getOccupationTimer()) + GlobalCyTranslator.getText("[ICON_OCCUPATION]", ()) + "</font>"
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_DRAFT", ()) + GlobalCyTranslator.getText(" [ICON_UNHAPPY]: ", ()) + str(pCity.getConscriptAngerTimer()) + "</font>"
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_HURRY_ANGER", (pCity.getHurryAngerTimer(),)) + "</font>"
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_DEFY_RESOLUTION", (pCity.getDefyResolutionAngerTimer(),)) + "</font>"
        ...
        sText = u"<font=3>%s %s: %d</font>" % (GlobalCyTranslator.getText("TXT_KEY_ESPIONAGE_CULTURE", ()), GlobalCyTranslator.getText("[ICON_UNHEALTHY]", ()), pCity.getEspionageHealthCounter())
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_TEMP_HAPPY", (pCity.getHappinessTimer(),)) + "</font>"
    ...
    def placeProduction(self):
        ...
        if pCity.isProduction():
            sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        screen.setTableText("WBCityProduction", 2, 0, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_CULTURELEVEL_NONE", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(),
                            WidgetTypes.WIDGET_PYTHON, 7878, -1, CvUtil.FONT_LEFT_JUSTIFY)
        iRow = 1
    ...
    def handleInput(self, inputClass):
        ...
        if inputClass.getFunctionName() == "ChangeBy":
            ...
            popup.setHeaderString(GlobalCyTranslator.getText("TXT_KEY_NAME_CITY", ()))
            popup.setBodyString(GlobalCyTranslator.getText("TXT_KEY_SETTLE_NEW_CITY_NAME", ()))
            ...
            gcgetPlayer(screen.getPullDownData("CityOwner", iIndex)).acquireCity(pCity, False, True)
            ...
            if iIndex == 0:
                ...
                pCity.setCulture(iPlayer, gc.getCultureLevelInfo(iIndex).getSpeedThreshold(GlobalCyGame.getGameSpeedType()), True)
            self.placeStats()
