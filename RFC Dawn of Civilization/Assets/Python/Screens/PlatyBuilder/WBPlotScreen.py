...
class WBPlotScreen:
    ...
    def interfaceScreen(self, pPlotX):
        ...
        screen.setText("PlotExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
        ...
        screen.addPullDownString("CurrentPlayer", GlobalCyTranslator.getText("TXT_KEY_CULTURELEVEL_NONE", ()), -1, -1, pPlot.getOwner() == -1)
        for i in xrange(gc.getMAX_PLAYERS()):
            pPlayerX = gcgetPlayer(i)
            if pPlayerX.isAlive():
        ...
        iY += 30
        iButtonWidth = 28
        screen.addCheckBoxGFC("SensibilityCheck", ",Art/Interface/Buttons/WorldBuilder/Gems.dds,Art/Interface/Buttons/FinalFrontier1_Atlas.dds,1,16", GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
        ...
        screen.addPullDownString("EditType", GlobalCyTranslator.getText("TXT_KEY_WB_SINGLE_PLOT", ()), 0, 0, iEditType == 0)
        screen.addPullDownString("EditType", GlobalCyTranslator.getText("TXT_KEY_WB_AREA_PLOTS", ()), 1, 1, iEditType == 1)
        screen.addPullDownString("EditType", GlobalCyTranslator.getText("TXT_KEY_WB_ALL_PLOTS", ()), 2, 2, iEditType == 2)
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_PLOT_DATA", ()), 0, 0, True)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_CONCEPT_EVENTS", ()), 1, 1, False)
        if pPlot.isOwned():
            ...
            if pPlot.isCity():
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_DATA", ()), 4, 4, False)
        if pPlot.getNumUnits() > 0:
            screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_UNIT_DATA", ()), 5, 5, False)
        ...
        for i in xrange(GlobalCyMap.numPlots()):
            pLoopPlot = GlobalCyMap.plotByIndex(i)
            if pLoopPlot.getX() == pPlot.getX() and pLoopPlot.getY() == pPlot.getY():
                iIndex = i
                break
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_PLOT_DATA", ())
        if pPlot.isCity():
        ...
        sText = u"<font=3b>%s ID: %d, %s: %d</font>" % (GlobalCyTranslator.getText("TXT_KEY_WB_PLOT", ()), iIndex, GlobalCyTranslator.getText("TXT_KEY_WB_AREA_ID", ()), pPlot.getArea())
        ...
        screen.addPullDownString("BonusClass", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()), -1, -1, True)
        screen.addPullDownString("BonusClass", GlobalCyTranslator.getText("TXT_KEY_GLOBELAYER_RESOURCES_GENERAL", ()), 0, 0, 0 == iSelectedClass)
        iBonusClass = 1
        ...
        screen.setImageButton("NextPlotUpButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_UPARROW").getPath(),
                              screen.getXResolution() / 2 - 12, self.iTable_Y, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1)
        screen.setImageButton("NextPlotDownButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_DOWNARROW").getPath(),
                              screen.getXResolution() / 2 - 12, self.iTable_Y + 48, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1)
        screen.setImageButton("NextPlotLeftButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_LEFT").getPath(),
                              screen.getXResolution() / 2 - 36, self.iTable_Y + 24, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1)
        screen.setImageButton("NextPlotRightButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_RIGHT").getPath(),
    ...
    def placeSigns(self):
        ...
        sText = GlobalCyTranslator.getText("[ICON_CULTURE]", ()) + gcgetPlayer(iCulturePlayer).getName()
        ...
        sText = GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_LANDMARKS", ()) + "</color></font>"
        ...
        for iPlayerX in xrange(gc.getMAX_PLAYERS()):
            ...
            if pPlayerX.isEverAlive():
                ...
                sText = "<font=3>" + CvPlatyBuilderScreen.CvWorldBuilderScreen().addComma(pPlot.getCulture(iPlayerX)) + GlobalCyTranslator.getText("[ICON_CULTURE]", ()) + "</font>"
    ...
    def placeStats(self):
        screen = CyGInterfaceScreen("WBPlotScreen", CvScreenEnums.WB_PLOT)
        iY = 180
        screen.setLabel("YieldHeader", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_YIELDS", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() / 10, iY, -0.1, FontTypes.GAME_FONT,
        ...
        for i in xrange(YieldTypes.NUM_YIELD_TYPES):
            ...
            sText = GlobalCyTranslator.getText("TXT_KEY_WB_BASE_YIELD", (gc.getYieldInfo(i).getDescription(), iYield,))
    ...
    def placeRivers(self):
        ...
        iY = screen.getYResolution() / 2
        screen.setLabel("PlotRiverHeader", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_MISC_RIVERS", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, iX, iY - 30, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
        pWestPlot = GlobalCyMap.plot(pPlot.getX() - 1, pPlot.getY())
        pNorthPlot = GlobalCyMap.plot(pPlot.getX(), pPlot.getY() + 1)
        if not pNorthPlot.isNone():
            screen.addCheckBoxGFC("RiverNorthAButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_LEFT").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                                  iX - 36, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
            screen.addCheckBoxGFC("RiverNorthBButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                                  iX - 12, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
            screen.addCheckBoxGFC("RiverNorthCButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_RIGHT").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                                  iX + 12, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
        ...
        if not pWestPlot.isNone():
            screen.addCheckBoxGFC("RiverWestAButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_UPARROW").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                                  iX - 60, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.addCheckBoxGFC("RiverEastAButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_UPARROW").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                              iX + 36, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
        iY += 24
        if not pWestPlot.isNone():
            screen.addCheckBoxGFC("RiverWestBButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                                  iX - 60, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.addCheckBoxGFC("RiverEastBButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                              iX + 36, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
        iY += 24
        if not pWestPlot.isNone():
            screen.addCheckBoxGFC("RiverWestCButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_DOWNARROW").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                                  iX - 60, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.addCheckBoxGFC("RiverEastCButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_DOWNARROW").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                              iX + 36, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
        if not pWestPlot.isNone():
        ...
        iY += 24
        screen.addCheckBoxGFC("RiverSouthAButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_LEFT").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                              iX - 36, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.addCheckBoxGFC("RiverSouthBButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                              iX - 12, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.addCheckBoxGFC("RiverSouthCButton", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_RIGHT").getPath(), GlobalCyArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                              iX + 12, iY, 24, 24, WidgetTypes.WIDGET_GENERAL, -1, -1, ButtonStyles.BUTTON_STYLE_LABEL)
    ...
    def placeRoutes(self):
        ...
        screen.setTableText("WBPlotRoutes", 0, 0, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_CULTURELEVEL_NONE", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(),
                            WidgetTypes.WIDGET_PYTHON, 6788, -1, CvUtil.FONT_LEFT_JUSTIFY)
        for item in lRoutes:
    ...
    def placeFeature(self):
        ...
        screen.setTableText("WBPlotFeature", 0, 0, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_CULTURELEVEL_NONE", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(),
                            WidgetTypes.WIDGET_PYTHON, 7874, -1, CvUtil.FONT_LEFT_JUSTIFY)
    ...
    def placeImprovements(self):
        ...
        if iImprovement > -1:
            if gc.getImprovementInfo(iImprovement).getUpgradeTime():
                ...
                sText = GlobalCyTranslator.getText("TXT_KEY_WB_UPGRADE_PROGRESS", (pPlot.getUpgradeTimeLeft(iImprovement, pPlot.getOwner()),))
        ...
        screen.setTableText("WBPlotImprovement", 0, 0, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_CULTURELEVEL_NONE", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(),
                            WidgetTypes.WIDGET_PYTHON, 7877, -1, CvUtil.FONT_LEFT_JUSTIFY)
    ...
    def placeBonus(self):
        ...
        screen.setTableText("WBPlotBonus", 0, 0, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_CULTURELEVEL_NONE", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(),
                            WidgetTypes.WIDGET_PYTHON, 6788, -1, CvUtil.FONT_LEFT_JUSTIFY)
        for item in lBonus:
    ...
    def placeScript(self):
        ...
        screen.addMultilineText("GameScriptDataText", pPlot.getScriptData(), screen.getXResolution() / 2 - iWidth / 2, iScript_Y + 25, iWidth, screen.getYResolution() - iScript_Y - 70, WidgetTypes.WIDGET_GENERAL, -1, -1,
    ...
    def handleInput(self, inputClass):
        ...
        if inputClass.getFunctionName() == "ChangeBy":
            ...
            pNewPlot = GlobalCyMap.plot(pPlot.getX() - 1, pPlot.getY())
            if not pNewPlot.isNone():
                self.interfaceScreen(pNewPlot)
            ...
            if inputClass.getData1() == 1030:
                GlobalCyGame.setPlotExtraYield(pPlot.getX(), pPlot.getY(), i, abs(iChange))
            elif inputClass.getData1() == 1031:
                iYield = pPlot.getYield(i)
                iImprovement = pPlot.getImprovementType()
                if iImprovement > -1:
                    iYield -= pPlot.calculateImprovementYieldChange(iImprovement, i, pPlot.getOwner(), False)
                GlobalCyGame.setPlotExtraYield(pPlot.getX(), pPlot.getY(), i, - min(abs(iChange), iYield))
            self.placeStats()
            ...
            if iEditType == 0:
                ...
                GlobalCyMap.setAllPlotTypes(PlotTypes(inputClass.getData()))
            self.interfaceScreen(pPlot)
            ...
            popup.setHeaderString(GlobalCyTranslator.getText("TXT_KEY_WB_LANDMARKS", ()))
