...
class WBTeamScreen:
    ...
    def interfaceScreen(self, iTeamX):
        ...
        sText = "<font=4b>" + GlobalCyTranslator.getText("TXT_KEY_WB_TEAM_DATA", ()).upper() + " (ID: " + str(iTeam) + ")</font>"
        ...
        screen.setText("TeamExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_PLAYER_DATA", ()), 0, 0, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_TEAM_DATA", ()), 1, 1, True)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_PROJECT", ()), 2, 2, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_TECH", ()), 3, 3, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()) + " + " + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_CITIES", ()), 4, 4, False)
        ...
        for i in xrange(gc.getMAX_TEAMS()):
            if gcgetTeam(i).isAlive():
                iLeader = gcgetTeam(i).getLeaderID()
                sName = utils.getLeaderNameOrCivName(i)
                if gcgetTeam(i).getNumMembers() > 1:
                    sName += " (" + str(gcgetTeam(i).getNumMembers()) + " " + GlobalCyTranslator.getText("TXT_KEY_MEMBERS_TITLE", ()) + ")"
        ...
        screen.addPullDownString("MergeTeam", GlobalCyTranslator.getText("TXT_KEY_WB_MERGE_TEAM", ()), -1, -1, True)
        for i in xrange(gc.getMAX_TEAMS()):
            if gcgetTeam(i).isAlive():
                if i == iTeam: continue
                iLeader = gcgetTeam(i).getLeaderID()
    ...
    def placeStats(self):
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_NUKE_INTERCEPTION", (pTeam.getNukeInterception(),)) + "</font>"
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_ENEMY_WAR_WEARINESS", (pTeam.getEnemyWarWearinessModifier(),)) + "</font>"
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("[ICON_STRENGTH]", ()) + GlobalCyTranslator.getText("TXT_KEY_MISC_MASTER", ()) + ": " + str(pTeam.getMasterPower()) + "</font>"
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("[ICON_STRENGTH]", ()) + GlobalCyTranslator.getText("TXT_KEY_MISC_VASSAL_SHORT", ()) + ": " + str(pTeam.getVassalPower()) + "</font>"
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("[ICON_ESPIONAGE]", ()) + GlobalCyTranslator.getText("TXT_KEY_WB_EVER", ()) + ": " + str(pTeam.getEspionagePointsEver()) + "</font>"
    ...
    def placeVotes(self):
        ...
        screen.setLabel("VoteHeader", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_GUARANTEED_ELIGIBILITY", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, iX + iWidth / 2, iY, -0.1, FontTypes.TITLE_FONT,
    ...
    def placeRoutes(self):
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_ROUTE", ())
        screen.setLabel("RouteHeader", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_MODIFY", (sText,)) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, iX + iWidth / 2, iY, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL,
                        -1, -1)
        iY += 30
        ...
        for item in lRoutes:
            ...
            if iChange != 0:
                sText = u"%+d%s %s" % (iChange, GlobalCyTranslator.getText("[ICON_MOVES]", ()), GlobalCyTranslator.getText("TXT_KEY_ESPIONAGE_SCREEN_COST", ()))
    ...
    def placeDomains(self):
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_PEDIA_DOMAIN", ())
        screen.setLabel("DomainHeader", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_MODIFY", (sText,)) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, iX + iWidth / 2, iY, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL,
                        -1, -1)
        iY += 30
        ...
        for i in xrange(DomainTypes.NUM_DOMAIN_TYPES):
            ...
            if iChange != 0:
                sText = u"%+d%s" % (iChange, GlobalCyTranslator.getText("[ICON_MOVES]", ()))
    ...
    def placeImprovements(self):
        ...
        iY = self.iTable_Y - 30
        sText = GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_IMPROVEMENT", ())
        screen.setLabel("ImprovementHeader", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_MODIFY", (sText,)) + "</font>", CvUtil.FONT_LEFT_JUSTIFY, iX, iY, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
    ...
    def placeMembers(self):
        ...
        iX = screen.getXResolution() / 4
        screen.setLabel("MemberHeader", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_MEMBERS_TITLE", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, iX + iWidth / 2, self.iTable_Y - 30, -0.1, FontTypes.TITLE_FONT,
                        WidgetTypes.WIDGET_GENERAL, -1, -1)
    ...
    def placeAbilities(self):
        ...
        sText = GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + "<font=4b>" + GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()) + " (+/-)</color></font>"
        ...
        if pTeam.isMapCentering():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_MAP_CENTERING", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_MAPCENTER").getPath(),
                            lAbilities[0][0], lAbilities[0][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isMapTrading():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_MAP_TRADING", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_MAPTRADING").getPath(), lAbilities[1][0],
                            lAbilities[1][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isTechTrading():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_TECH_TRADING", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_TECHTRADING").getPath(),
                            lAbilities[2][0], lAbilities[2][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isGoldTrading():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_GOLD_TRADING", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_GOLDTRADING").getPath(),
                            lAbilities[3][0], lAbilities[3][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isOpenBordersTrading():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_MISC_OPEN_BORDERS", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_OPENBORDERS").getPath(),
                            lAbilities[4][0], lAbilities[4][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isDefensivePactTrading():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_MISC_DEFENSIVE_PACT", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_DEFENSIVEPACT").getPath(),
                            lAbilities[5][0], lAbilities[5][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isPermanentAllianceTrading():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_MISC_PERMANENT_ALLIANCE", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_PERMALLIANCE").getPath(),
                            lAbilities[6][0], lAbilities[6][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isVassalStateTrading():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_VASSAL_TRADING", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_VASSAL").getPath(), lAbilities[7][0],
                            lAbilities[7][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isBridgeBuilding():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_BRIDGE_BUILDING", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_BRIDGEBUILDING").getPath(),
                            lAbilities[8][0], lAbilities[8][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isIrrigation():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_IRRIGATION", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_IRRIGATION").getPath(),
                            lAbilities[9][0], lAbilities[9][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isIgnoreIrrigation():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_IGNORE_IRRIGATION", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_NOIRRIGATION").getPath(),
                            lAbilities[10][0], lAbilities[10][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isWaterWork():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_WATER_WORK", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_WATERWORK").getPath(), lAbilities[11][0],
                            lAbilities[11][1], -1, CvUtil.FONT_LEFT_JUSTIFY)

        iRow = screen.appendTableRow("WBAbilities")
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if pTeam.isExtraWaterSeeFrom():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setTableText("WBAbilities", 0, iRow, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_EXTRA_WATER_SIGHT", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_TECH_LOS").getPath(), lAbilities[12][0],
                            lAbilities[12][1], -1, CvUtil.FONT_LEFT_JUSTIFY)
