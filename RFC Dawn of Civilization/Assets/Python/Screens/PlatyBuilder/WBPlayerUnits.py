...
class WBPlayerUnits:
    ...
    def interfaceScreen(self, iPlayerX):
        ...
        screen.setText("WBExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
        ...
        screen.addPullDownString("CopyType", GlobalCyTranslator.getText("TXT_KEY_WB_ACTIVITY", ()), 5, 5, 5 == iCopyType)
        ...
        screen.setLabel("DeleteCitiesText", "Background", "<font=4b>" + GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()) + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() / 2 - 35, iY, -0.1, FontTypes.GAME_FONT,
        ...
        screen.setLabel("DeleteUnitsText", "Background", "<font=4b>" + GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()) + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 75, iY, -0.1, FontTypes.GAME_FONT,
                        WidgetTypes.WIDGET_GENERAL, -1, -1)
    ...
    def sortUnits(self):
        ...
        pUnitOwner = gcgetPlayer(iUnitOwner)
    ...
    def sortCities(self):
        ...
        global iCityOwner
        pPlayer = gcgetPlayer(iPlayer)
        pCityOwner = gcgetPlayer(iCityOwner)
    ...
    def placeCurrentUnit(self):
        ...
        lStatus = [GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(), gc.getMissionInfo(MissionTypes.MISSION_FORTIFY).getButton(), gc.getMissionInfo(MissionTypes.MISSION_SKIP).getButton()]
        ...
        screen.setTableColumnHeader("WBUnitList", 2, GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()), iColWidth * 4)
        screen.setTableColumnHeader("WBUnitList", 3, "ID", iColWidth * 2)
        screen.setTableColumnHeader("WBUnitList", 4, GlobalCyTranslator.getText("TXT_KEY_WB_XLEVEL", ()), iColWidth * 1)
        screen.setTableColumnHeader("WBUnitList", 5, GlobalCyTranslator.getText("[ICON_STRENGTH]", ()), iColWidth * 1)
        screen.setTableColumnHeader("WBUnitList", 6, GlobalCyTranslator.getText("[ICON_MOVES]", ()), iColWidth * 1)
        ...
        for i in lUnits:
            ...
            if loopUnit.getGroup().readyToMove(False):
                iStatus = 2
            sColor = GlobalCyTranslator.getText("[COLOR_NEGATIVE_TEXT]", ())
    ...
    def placeCurrentCity(self):
        ...
        screen.setTableColumnHeader("WBCityList", 1, GlobalCyTranslator.getText("TXT_KEY_CONCEPT_CITIES", ()), iColWidth * 3)
        screen.setTableColumnHeader("WBCityList", 2, "ID", iColWidth * 2)
        screen.setTableColumnHeader("WBCityList", 3, GlobalCyTranslator.getText("[ICON_CULTURE]", ()), iColWidth * 2)
        screen.setTableColumnHeader("WBCityList", 4, GlobalCyTranslator.getText("[ICON_ANGRYPOP]", ()), iColWidth * 1)
        screen.setTableColumnHeader("WBCityList", 5, GlobalCyTranslator.getText("[ICON_HAPPY]", ()), iColWidth * 1)
        screen.setTableColumnHeader("WBCityList", 6, GlobalCyTranslator.getText("[ICON_HEALTHY]", ()), iColWidth * 1)
    ...
    def placeCityMap(self):
        ...
        sText = GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + "<font=4b>" + pCity.getName() + "</color></font>"
    ...
    def getCityData(self, pCity):
        pPlayer = gcgetPlayer(iCityOwner)
        sText = "<font=3>"
        if pCity.isCapital():
        ...
        sText += u"\n%s: %d/%d (%s)" % (GlobalCyTranslator.getText("[ICON_CULTURE]", ()), pCity.getCulture(iCityOwner), pCity.getCultureThreshold(), gc.getCultureLevelInfo(pCity.getCultureLevel()).getDescription())
        ...
        sText += "\n" + GlobalCyTranslator.getText("TXT_KEY_WB_CITY", ()) + " ID: " + str(pCity.getID())
        sText += "\n" + "X: " + str(pCity.getX()) + ", Y: " + str(pCity.getY())
        sText += "\n" + GlobalCyTranslator.getText("TXT_KEY_WB_AREA_ID", ()) + ": " + str(pCity.plot().getArea())
    ...
    def getUnitData(self, pUnit):
        ...
        sText += "\n" + GlobalCyTranslator.getText("TXT_KEY_WB_UNIT", ()) + " ID: " + str(pUnit.getID())
    ...
    def addPageSwitch(self):
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_TEAM_DATA", ()), 1, 1, False)
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()) + " + " + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_CITIES", ()), 4, 4, True)
        pCityOwner = gcgetPlayer(iCityOwner)
        if pCityOwner:
            pCity = pCityOwner.getCity(iCityID)
            if not pCity.isNone():
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_DATA", ()), 9, 9, False)
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_DATA2", ()), 10, 10, False)
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_BUILDING", ()), 14, 14, False)
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_CITY", ()) + " " + GlobalCyTranslator.getText("TXT_KEY_WB_PLOT_DATA", ()), 12, 12, False)
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_CITY", ()) + " " + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_EVENTS", ()), 13, 13, False)
        pUnitOwner = gcgetPlayer(iUnitOwner)
        if pUnitOwner:
            pUnit = pUnitOwner.getUnit(iUnitID)
            if not pUnit.isNone():
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_UNIT_DATA", ()), 5, 5, False)
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_PROMOTION", ()), 6, 6, False)
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_UNIT", ()) + " " + GlobalCyTranslator.getText("TXT_KEY_WB_PLOT_DATA", ()), 7, 7, False)
                screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_UNIT", ()) + " " + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_EVENTS", ()), 8, 8, False)
