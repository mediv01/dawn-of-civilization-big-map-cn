...
class WBPromotionScreen:
    ...
    def interfaceScreen(self, pUnitX):
        ...
        screen.setText("WBPromotionExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_UNIT_DATA", ()), 0, 0, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_PROMOTION", ()), 1, 1, True)
        ...
        sText = u"<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_COPY_ALL", (GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()),)) + "</font>"
