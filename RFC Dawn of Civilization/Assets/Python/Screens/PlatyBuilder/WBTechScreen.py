...
class WBTechScreen:
    ...
    def interfaceScreen(self, iTeamX):
        ...
        screen.setText("WBTechExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
                       FontTypes.TITLE_FONT, WidgetTypes.WIDGET_CLOSE_SCREEN, -1, -1)
        screen.setLabel("TechHeader", "Background", u"<font=4b>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_TECH", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() / 2, 20, -0.1, FontTypes.TITLE_FONT,
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_TECH", ()), 3, 3, True)
        ...
        screen.addPullDownString("TechEra", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()), -1, -1, True)
