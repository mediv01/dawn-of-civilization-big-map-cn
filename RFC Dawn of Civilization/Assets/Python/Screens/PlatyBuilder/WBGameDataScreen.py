...
class WBGameDataScreen:
    ...
    def interfaceScreen(self):
        ...
        screen.setLabel("GameDataHeader", "Background", "<font=4b>" + GlobalCyTranslator.getText("TXT_KEY_PITBOSS_GAME_OPTIONS", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() / 2, 20, -0.1, FontTypes.TITLE_FONT,
                        WidgetTypes.WIDGET_GENERAL, -1, -1)
        screen.setText("GameDataExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_RELIGION", ()), 8, 8, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_CONCEPT_CORPORATIONS", ()), 9, 9, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PITBOSS_GAME_OPTIONS", ()), 10, 10, True)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_INFO_SCREEN", ()), 11, 11, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_STOREDDATA", ()), 12, 12, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_PLAYER_ENABLED", ()), 13, 13, False)
    ...
    def placeStats(self):
        ...
        iYear = GlobalCyGame.getStartYear()
        if iYear < 0:
            sYear = str(-iYear) + " BC"
        else:
            sYear = str(iYear) + " AD"
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_START_YEAR", ()) + ": " + sYear
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_MAX_CITY_ELIMINATION", (GlobalCyGame.getMaxCityElimination(),))
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_GAME_TURN", (GlobalCyGame.getGameTurn(),))
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_TARGET_SCORE", (GlobalCyGame.getTargetScore(),))
        ...
        iY += 30
        iYear = GlobalCyGame.getGameTurnYear()
        if iYear < 0:
            sYear = str(-iYear) + " BC"
        else:
            sYear = str(iYear) + " AD"
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_GAME_YEAR", (sYear,))
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_NUKES_EXPLODED", (GlobalCyGame.getNukesExploded(),))
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_ESTIMATED_END_TURN", (GlobalCyGame.getEstimateEndTurn(),))
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_HEADING_TRADEROUTE_LIST", ()) + ": " + str(gc.getDefineINT("INITIAL_TRADE_ROUTES") + GlobalCyGame.getTradeRoutes())
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_MAX_TURNS", (GlobalCyGame.getMaxTurns(),))
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_AI_AUTOPLAY", (GlobalCyGame.getAIAutoPlay(),))
        ...
        iY += 30
        screen.setLabel("AutoPlayStop", "Background", "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_AI_AUTOPLAY_WARNING", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() / 4, iY, -0.1, FontTypes.TITLE_FONT,
                        WidgetTypes.WIDGET_GENERAL, -1, -1)

    def placeNewPlayer(self):
        if GlobalCyGame.countCivPlayersEverAlive() == gc.getMAX_CIV_PLAYERS(): return
        screen = CyGInterfaceScreen("WBGameDataScreen", CvScreenEnums.WB_GAMEDATA)
        sHeaderText = GlobalCyTranslator.getText("TXT_KEY_WB_ADD_NEW_PLAYER", ())

        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if bRepeat:
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setText("AllowsRepeat", "Background", "<font=3b>" + sColor + GlobalCyTranslator.getText("TXT_KEY_MAIN_MENU_REPEAT_PASSWORD", ()) + "</color></font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 20,
                       self.iNewPlayer_Y - 30, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_PYTHON, 1029, 30)
        ...
        for item in xrange(gc.getNumCivilizationInfos()):
            ...
            if GlobalCyGame.isCivEverActive(item) and not bRepeat: continue
        ...
        if iSelectedCiv > -1:
            ...
            for item in xrange(gc.getNumLeaderHeadInfos()):
                ...
                if not GlobalCyGame.isLeaderEverActive(item) or bRepeat:
                    if GlobalCyGame.isOption(GameOptionTypes.GAMEOPTION_LEAD_ANY_CIV) or gc.getCivilizationInfo(iSelectedCiv).isLeaders(item):
            ...
            if iSelectedLeader > -1:
                ...
                sText = GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + "<font=4b>" + GlobalCyTranslator.getText("TXT_KEY_MAIN_MENU_LOADSAVE_CREATE", ()) + "</color></font>"
        ...
        screen.setLabel("NewPlayerHeader", "Background", "<font=3b>" + sHeaderText + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() * 3 / 4, self.iNewPlayer_Y - 30, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1,
                        -1)
    ...
    def placeScript(self):
        ...
        screen.addMultilineText("GameScriptDataText", GlobalCyGame.getScriptData(), 20, self.iScript_Y + 25, screen.getXResolution() / 2 - 40, 50, WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
    ...
    def placeGameOptions(self):
        ...
        if bHiddenOption:
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        screen.setText("HiddenOptions", "Background", "<font=3b>" + sColor + GlobalCyTranslator.getText("TXT_KEY_WB_SHOW_HIDDEN", ()) + "</color></font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 20, self.iGameOption_Y - 30, -0.1,
        ...
        lList2 = []
        lList2.append([GlobalCyTranslator.getText("TXT_KEY_WB_IGNORE_AI_UHV", ()), 2000])
        lList2.append([GlobalCyTranslator.getText("TXT_KEY_WB_UNLIMITED_SWITCHING", ()), 2001])
        lList2.append([GlobalCyTranslator.getText("TXT_KEY_WB_NO_CONGRESS", ()), 2002])
        lList2.append([GlobalCyTranslator.getText("TXT_KEY_WB_NO_PLAGUE", ()), 2003])
        lList2.sort()

        # Stored variables
        lList3 = []
        lList3.append([GlobalCyTranslator.getText("TXT_KEY_WB_ALREADY_SWITCHED", ()), 3001])
        lList3.append([GlobalCyTranslator.getText("TXT_KEY_WB_CONGRESS_TURNS", ()), 3002])
        lList3.sort()
        ...
        for i in xrange(len(lList)):
            ...
            bEnabled = GlobalCyGame.isOption(item)
            bDefault = False
            ...
            sText = self.colorText(GlobalCyTranslator.getText("TXT_KEY_WB_DEFAULT", ()), bDefault)
        ...
        screen.setTableText("WBGameOptions", 0, iNumRows + 2, GlobalCyTranslator.getText("TXT_KEY_WB_SECONDARY_CIVS", ()), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
        screen.setTableText("WBGameOptions", 2, iNumRows + 2, GlobalCyTranslator.getText("TXT_KEY_WB_RFC_OPTIONS", ()), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
        screen.setTableText("WBGameOptions", 4, iNumRows + 2, GlobalCyTranslator.getText("TXT_KEY_WB_RFC_VARIABLES", ()), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
        ...
        for iCiv in lSecondaryCivs:
            ...
            sText = self.colorText(gcgetPlayer(iCiv).getCivilizationShortDescription(0), bEnabled)
    ...
    def handleInput(self, inputClass):
        ...
        if inputClass.getFunctionName() == "CurrentPage":
            ...
            if inputClass.getData1() == 1030:
                GlobalCyGame.setStartYear(GlobalCyGame.getStartYear() + abs(iChange))
            ...
            if inputClass.getData1() == 1030:
                GlobalCyGame.setMaxCityElimination(GlobalCyGame.getMaxCityElimination() + abs(iChange))
            elif inputClass.getData1() == 1031:
                GlobalCyGame.setMaxCityElimination(max(0, GlobalCyGame.getMaxCityElimination() - abs(iChange)))
            self.placeStats()

        elif inputClass.getFunctionName().find("GameTurn") > -1:
            if inputClass.getData1() == 1030:
                iChange = min(abs(iChange), GlobalCyGame.getMaxTurns() - GlobalCyGame.getElapsedGameTurns())
                GlobalCyGame.setGameTurn(GlobalCyGame.getGameTurn() + iChange)
                GlobalCyGame.changeMaxTurns(- iChange)
            elif inputClass.getData1() == 1031:
                iChange = min(GlobalCyGame.getGameTurn(), abs(iChange))
                GlobalCyGame.setGameTurn(GlobalCyGame.getGameTurn() - iChange)
                GlobalCyGame.changeMaxTurns(iChange)
            self.placeStats()
            ...
            if inputClass.getData1() == 1030:
                GlobalCyGame.setTargetScore(GlobalCyGame.getTargetScore() + abs(iChange))
            elif inputClass.getData1() == 1031:
                GlobalCyGame.setTargetScore(max(0, GlobalCyGame.getTargetScore() - abs(iChange)))
            self.placeStats()

        elif inputClass.getFunctionName().find("EstimateEndTurn") > -1:
            if inputClass.getData1() == 1030:
                GlobalCyGame.setEstimateEndTurn(GlobalCyGame.getEstimateEndTurn() + iChange)
            elif inputClass.getData1() == 1031:
                GlobalCyGame.setEstimateEndTurn(max(0, GlobalCyGame.getEstimateEndTurn() - iChange))
            self.placeStats()

        elif inputClass.getFunctionName().find("NukesExploded") > -1:
            if inputClass.getData1() == 1030:
                GlobalCyGame.changeNukesExploded(abs(iChange))
            elif inputClass.getData1() == 1031:
                GlobalCyGame.changeNukesExploded(- min(GlobalCyGame.getNukesExploded(), abs(iChange)))
            self.placeStats()

        elif inputClass.getFunctionName().find("MaxTurns") > -1:
            if inputClass.getData1() == 1030:
                GlobalCyGame.changeMaxTurns(abs(iChange))
            elif inputClass.getData1() == 1031:
                GlobalCyGame.changeMaxTurns(- min(GlobalCyGame.getMaxTurns(), abs(iChange)))
            self.placeStats()

        elif inputClass.getFunctionName().find("TradeRoutes") > -1:
            if inputClass.getData1() == 1030:
                GlobalCyGame.changeTradeRoutes(min(abs(iChange), gc.getDefineINT("MAX_TRADE_ROUTES") - gc.getDefineINT("INITIAL_TRADE_ROUTES") - GlobalCyGame.getTradeRoutes()))
            elif inputClass.getData1() == 1031:
                GlobalCyGame.changeTradeRoutes(- min(GlobalCyGame.getTradeRoutes(), abs(iChange)))
            self.placeStats()

        elif inputClass.getFunctionName().find("AIAutoPlay") > -1:
            if inputClass.getData1() == 1030:
                GlobalCyGame.setAIAutoPlay(GlobalCyGame.getAIAutoPlay() + abs(iChange))
            elif inputClass.getData1() == 1031:
                GlobalCyGame.setAIAutoPlay(max(0, GlobalCyGame.getAIAutoPlay() - abs(iChange)))
            self.placeStats()

        elif inputClass.getFunctionName() == "WBGameOptions":
            iGameOption = inputClass.getData2()
            if iGameOption < gc.getNumGameOptionInfos():
                GlobalCyGame.setOption(iGameOption, not GlobalCyGame.isOption(iGameOption))
            ...
            for i in xrange(gc.getMAX_CIV_PLAYERS()):
                if not gcgetPlayer(i).isEverAlive():
                    GlobalCyGame.addPlayer(i, iSelectedLeader, iSelectedCiv)
                    break
            screen.hideScreen()
            ...
            popup.createEditBox(GlobalCyGame.getScriptData())
            popup.launch()
    ...
    def checkOptions(self, iGameOption):
        if iGameOption == GameOptionTypes.GAMEOPTION_LEAD_ANY_CIV:
            ...
            iSelectedLeader = -1
            self.interfaceScreen()
        elif iGameOption == GameOptionTypes.GAMEOPTION_NO_GOODY_HUTS and GlobalCyGame.isOption(iGameOption):
            CyMapGenerator().eraseGoodies()
        elif iGameOption == GameOptionTypes.GAMEOPTION_NO_VASSAL_STATES and GlobalCyGame.isOption(iGameOption):
            for iTeamX in xrange(gc.getMAX_CIV_TEAMS()):
                pTeamX = gcgetTeam(iTeamX)
                for iTeamY in xrange(gc.getMAX_CIV_TEAMS()):
                    pTeamX.freeVassal(iTeamY)
        elif iGameOption == GameOptionTypes.GAMEOPTION_ALWAYS_PEACE and GlobalCyGame.isOption(iGameOption):
            for iTeamX in xrange(gc.getMAX_CIV_TEAMS()):
                pTeamX = gcgetTeam(iTeamX)
                if GlobalCyGame.isOption(GameOptionTypes.GAMEOPTION_ALWAYS_WAR) and pTeamX.isHuman(): continue
                for iTeamY in xrange(gc.getMAX_CIV_TEAMS()):
                    if GlobalCyGame.isOption(GameOptionTypes.GAMEOPTION_ALWAYS_WAR) and gcgetTeam(iTeamY).isHuman(): continue
                    pTeamX.makePeace(iTeamY)
        elif iGameOption == GameOptionTypes.GAMEOPTION_ONE_CITY_CHALLENGE and GlobalCyGame.isOption(iGameOption):
        ...
        elif iGameOption == GameOptionTypes.GAMEOPTION_NO_BARBARIANS and GlobalCyGame.isOption(iGameOption):
            pPlayerBarb = gcgetPlayer(gc.getBARBARIAN_PLAYER())
