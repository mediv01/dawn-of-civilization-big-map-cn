...
class WBUnitScreen:
    ...
    def interfaceScreen(self, pUnitX):
        ...
        screen.setText("UnitExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
        ...
        screen.addPullDownString("OwnerType", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()), 0, 0, 0 == iOwnerType)
        screen.addPullDownString("OwnerType", GlobalCyTranslator.getText("TXT_KEY_PITBOSS_TEAM", ()), 2, 2, 2 == iOwnerType)
        screen.addPullDownString("OwnerType", GlobalCyTranslator.getText("TXT_KEY_MAIN_MENU_PLAYER", ()), 1, 1, 1 == iOwnerType)

        screen.addDropDownBoxGFC("CopyType", 20, self.iTable_Y - 60, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT)
        screen.addPullDownString("CopyType", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()), 0, 0, 0 == iCopyType)
        screen.addPullDownString("CopyType", GlobalCyTranslator.getText("TXT_KEY_SPACE_SHIP_SCREEN_TYPE_BUTTON", ()), 1, 1, 1 == iCopyType)
        screen.addPullDownString("CopyType", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT_COMBAT", ()), 2, 2, 2 == iCopyType)
        screen.addPullDownString("CopyType", GlobalCyTranslator.getText("TXT_KEY_PEDIA_DOMAIN", ()), 3, 3, 3 == iCopyType)
        screen.addPullDownString("CopyType", GlobalCyTranslator.getText("TXT_KEY_WB_GROUP", ()), 4, 4, 4 == iCopyType)

        screen.addDropDownBoxGFC("PlotType", 20, self.iTable_Y - 30, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT)
        screen.addPullDownString("PlotType", GlobalCyTranslator.getText("TXT_KEY_WB_SINGLE_PLOT", ()), 0, 0, iPlotType == 0)
        screen.addPullDownString("PlotType", GlobalCyTranslator.getText("TXT_KEY_WB_AREA_PLOTS", ()), 1, 1, iPlotType == 1)
        screen.addPullDownString("PlotType", GlobalCyTranslator.getText("TXT_KEY_WB_ALL_PLOTS", ()), 2, 2, iPlotType == 2)
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_UNIT_DATA", ()), 0, 0, True)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_PROMOTION", ()), 1, 1, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_PLAYER_DATA", ()), 2, 2, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_TEAM_DATA", ()), 3, 3, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_PLOT_DATA", ()), 4, 4, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_CONCEPT_EVENTS", ()), 5, 5, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()) + " + " + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_CITIES", ()), 6, 6, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_INFO_SCREEN", ()), 11, 11, False)
        ...
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_XLEVEL", ()), 0, 0, 0 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("INTERFACE_PANE_EXPERIENCE", ()), 1, 1, 1 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_DEMO_SCREEN_STRENGTH_TEXT", ()), 2, 2, 2 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_DAMAGE", ()), 3, 3, 3 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_MOVES", ()), 4, 4, 4 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_IMMOBILE_TIMER", ()), 5, 5, 5 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_PROMOTION_READY", ()), 6, 6, 6 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_MADE_ATTACK", ()), 7, 7, 7 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_MADE_INTERCEPT", ()), 8, 8, 8 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_DIRECTION", ()), 9, 9, 9 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_UNIT_AI", ()), 10, 10, 10 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_CARGO_SPACE", ()), 11, 11, 11 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_SCRIPT_DATA", ()), 12, 12, 12 == iChangeType)

        iX += iWidth
        sText = GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_COPY_ALL", (GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()),)) + "</color></font>"
        ...
        sText = u"<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_HIDE_INACTIVE", ()) + "</font>"
    ...
    def placeMissions(self):
        ...
        screen.setText("PushMission", "Background", "<font=3b>" + GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + GlobalCyTranslator.getText("TXT_KEY_WB_PUSH_MISSION", ()) + "</color></font>", CvUtil.FONT_CENTER_JUSTIFY,
                       screen.getXResolution() * 7 / 10, iY - 30, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
        sText = (GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_TARGET_PLOT", ()) + ": " + "(%d,%d)" + "</color></font>") % (self.top.iTargetPlotX, self.top.iTargetPlotY)
        ...
        for i in xrange(gc.getNumMissionInfos()):
            ...
            if sType == "MISSION_MOVE_TO_UNIT":
                ...
                pTargetPlot = GlobalCyMap.plot(lData1[0], iData2)
        ...
        if sMissionType in self.lSelectableMissions:
            ...
            for i in xrange(len(lMissionData)):
                ...
                if pUnit.getGroup().canStartMission(iMissionType, iData1, -1, pPlot, True):
                    ...
                    if iData1 == iMissionData1:
                        sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
                    screen.setTableText("MissionInput", 0, iRow, "<font=3>" + sColor + sDescription + "</font></color>", ItemInfo.getButton(), WidgetTypes.WIDGET_PYTHON, self.lSelectableMissions[sMissionType][1], iData1,
            ...
            if iTech > -1:
                ...
                iRow = screen.appendTableRow("MissionInput")
                sText = u"%c %d / %d" % (gc.getCommerceInfo(CommerceTypes.COMMERCE_RESEARCH).getChar(), gcgetTeam(pUnit.getTeam()).getResearchProgress(iTech), gcgetTeam(pUnit.getTeam()).getResearchCost(iTech))
                screen.setTableText("MissionInput", 0, iRow, "<font=3>" + sText + "</font>", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
                iRow = screen.appendTableRow("MissionInput")
                sText = u"%c %s%+d</color>" % (gc.getCommerceInfo(CommerceTypes.COMMERCE_RESEARCH).getChar(), GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ()), pUnit.getDiscoverResearch(iTech))
                screen.setTableText("MissionInput", 0, iRow, "<font=3>" + sText + "</font>", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
            ...
            if pPlot.isCity():
                ...
                screen.setTableText("MissionInput", 0, iRow, "<font=3>" + sText + "</font>", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
                iRow = screen.appendTableRow("MissionInput")
                sText = u"%c %s%+d</color>" % (gc.getCommerceInfo(CommerceTypes.COMMERCE_CULTURE).getChar(), GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ()), pUnit.getGreatWorkCulture(pPlot))
                screen.setTableText("MissionInput", 0, iRow, "<font=3>" + sText + "</font>", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
            ...
            if pPlot.isCity():
                ...
                if pCity.isProductionBuilding():
                    ...
                    screen.setTableText("MissionInput", 0, iRow, "<font=3>" + gc.getBuildingInfo(iBuilding).getDescription() + "</font>", gc.getBuildingInfo(iBuilding).getButton(), WidgetTypes.WIDGET_PYTHON, 7870, iBuilding,
                                        CvUtil.FONT_LEFT_JUSTIFY)
                elif pCity.isProductionProject():
                    iProject = pCity.getProductionProject()
                    screen.setTableText("MissionInput", 0, iRow, "<font=3>" + gc.getProjectInfo(iProject).getDescription() + "</font>", gc.getProjectInfo(iProject).getButton(), WidgetTypes.WIDGET_PYTHON, 6785, iProject,
                                        CvUtil.FONT_LEFT_JUSTIFY)
                ...
                screen.setTableText("MissionInput", 0, iRow, "<font=3>" + sText + "</font>", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
                iRow = screen.appendTableRow("MissionInput")
                sText = u"%c %s%+d</color>" % (gc.getYieldInfo(YieldTypes.YIELD_PRODUCTION).getChar(), GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ()), pUnit.getHurryProduction(pPlot))
                screen.setTableText("MissionInput", 0, iRow, "<font=3>" + sText + "</font>", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)

    def placeDirection(self):
        screen = CyGInterfaceScreen("WBUnitScreen", CvScreenEnums.WB_UNIT)
        iY = screen.getYResolution() / 2
        screen.setLabel("UnitDirectionText", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_DIRECTION", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() / 2, iY, -0.1, FontTypes.TITLE_FONT,
        ...
        if pUnit.isPromotionReady():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_PROMOTION_READY", ())
        ...
        if pUnit.isMadeAttack():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_MADE_ATTACK", ())
        ...
        if pUnit.isMadeInterception():
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_MADE_INTERCEPT", ())
    ...
    def placeScript(self):
        ...
        sText = GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_SCRIPT_DATA", ()) + "</color></font>"
    ...
    def placeStats(self):
        screen = CyGInterfaceScreen("WBUnitScreen", CvScreenEnums.WB_UNIT)
        sText = GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + "<font=4b>" + pUnit.getName() + "</color></font>"
        ...
        sText = u"<font=3b>%s ID: %d, %s ID: %d</font>" % (GlobalCyTranslator.getText("TXT_KEY_WB_UNIT", ()), pUnit.getID(), GlobalCyTranslator.getText("TXT_KEY_WB_GROUP", ()), pUnit.getGroupID())
        ...
        sText = "<font=3b>%s, X: %d, Y: %d</font>" % (GlobalCyTranslator.getText("TXT_KEY_WB_LATITUDE", (pPlot.getLatitude(),)), pPlot.getX(), pPlot.getY())
        ...
        screen.addPullDownString("CommandUnits", GlobalCyTranslator.getText("TXT_KEY_WB_UNIT", ()), 0, 0, iCommandUnitType == 0)
        screen.addPullDownString("CommandUnits", GlobalCyTranslator.getText("TXT_KEY_SPACE_SHIP_SCREEN_TYPE_BUTTON", ()), 1, 1, iCommandUnitType == 1)
        screen.addPullDownString("CommandUnits", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT_COMBAT", ()), 2, 2, iCommandUnitType == 2)
        screen.addPullDownString("CommandUnits", GlobalCyTranslator.getText("TXT_KEY_PEDIA_DOMAIN", ()), 3, 3, 3 == iCommandUnitType == 3)
        screen.addPullDownString("CommandUnits", GlobalCyTranslator.getText("TXT_KEY_WB_GROUP", ()), 4, 4, iCommandUnitType == 4)
        screen.addPullDownString("CommandUnits", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()), 5, 5, iCommandUnitType == 5)

        iY += 30
        screen.addDropDownBoxGFC("Commands", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT)
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_WB_COMMANDS", ()), 0, 0, True)
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_OPTIONS_RESET", ()), 1, 1, False)
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_MISSION_MOVE_TO", ()), 2, 2, False)
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_MAP_SCRIPT_COPY", ()), 3, 3, False)
        screen.addPullDownString("Commands", GlobalCyTranslator.getText("TXT_KEY_ESPIONAGE_DESTROY_UNIT", ()), 4, 4, False)
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_XLEVEL", ()) + ": " + str(pUnit.getLevel())
        ...
        sText = GlobalCyTranslator.getText("INTERFACE_PANE_EXPERIENCE", ()) + ": " + str(pUnit.getExperience())
        ...
        sText = GlobalCyTranslator.getText("INTERFACE_PANE_STRENGTH", ()) + " " + str(pUnit.baseCombatStr()) + GlobalCyTranslator.getText("[ICON_STRENGTH]", ())
        ...
        iY += 30
        sText = GlobalCyTranslator.getText("INTERFACE_PANE_AIR_STRENGTH", ()) + " " + str(pUnit.airBaseCombatStr())
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_DAMAGE", ()) + ": " + str(pUnit.getDamage())
        ...
        sText = u"%s: %.2f" % (GlobalCyTranslator.getText("TXT_KEY_WB_MOVES", ()), float(pUnit.movesLeft()) / gc.getDefineINT("MOVE_DENOMINATOR")) + GlobalCyTranslator.getText("[ICON_MOVES]", ())
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_IMMOBILE_TIMER", ()) + ": " + str(pUnit.getImmobileTimer())
    ...
    def placeUnitType(self):
        ...
        screen.addPullDownString("LeaderType", GlobalCyTranslator.getText("TXT_KEY_FOREIGN_ADVISOR_LEADER", ()), 0, 0, not bUnitType)
        screen.addPullDownString("LeaderType", GlobalCyTranslator.getText("TXT_KEY_SPACE_SHIP_SCREEN_TYPE_BUTTON", ()), 1, 1, bUnitType)

        iY += 30
        screen.addDropDownBoxGFC("CombatClass", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT)
        screen.addPullDownString("CombatClass", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()), -2, -2, -2 == iSelectedClass)
        screen.addPullDownString("CombatClass", GlobalCyTranslator.getText("TXT_PEDIA_NON_COMBAT", ()), -1, -1, -1 == iSelectedClass)
        ...
        for i in xrange(gc.getNumUnitInfos()):
            ...
            if CvPlatyBuilderScreen.bHideInactive:
                iCivilization = gcgetPlayer(pUnit.getOwner()).getCivilizationType()
        ...
        for i in lUnits:
            ...
            if pUnitX.getOwner() == pUnit.getOwner():
                if pUnitX.getID() == pUnit.getID():
                    ...
                    sColor = GlobalCyTranslator.getText("[COLOR_YELLOW]", ())
    ...
    def placeCargo(self):
        ...
        screen.addPullDownString("CargoType", GlobalCyTranslator.getText("TXT_KEY_UNIT_TRANSPORT", ()), 0, 0, not bCargo)
        screen.addPullDownString("CargoType", GlobalCyTranslator.getText("TXT_KEY_WB_CARGO_SPACE", ()), 1, 1, bCargo)
        ...
        if bCargo:
            ...
            sText = GlobalCyTranslator.getText("TXT_KEY_WB_CARGO_SPACE", ()) + " (" + str(pUnit.getCargo()) + "/" + str(pUnit.cargoSpace()) + ")"
    ...
    def handleInput(self, inputClass):
        ...
        if sName == "ChangeBy":
            ...
            popup.setBodyString(GlobalCyTranslator.getText("TXT_KEY_RENAME_UNIT", ()))
            ...
            if inputClass.getData1() >= 8300:
                ...
                self.interfaceScreen(gcgetPlayer(iPlayer).getUnit(inputClass.getData2()))
            ...
            pUnitX = gcgetPlayer(iPlayerX).getUnit(inputClass.getData2())
            if bCargo:
                if pUnitX.getTransportUnit().getID() == pUnit.getID():
            ...
            popup.setHeaderString(GlobalCyTranslator.getText("TXT_KEY_WB_SCRIPT", ()))
    ...
    def doAllCommands(self, pUnitX, iIndex):
        if iIndex == 1:
            ...
            for i in xrange(iChange + 1):
                pNewUnit = gcgetPlayer(pUnitX.getOwner()).initUnit(pUnitX.getUnitType(), pUnitX.getX(), pUnitX.getY(), UnitAITypes.NO_UNITAI, DirectionTypes.NO_DIRECTION)
    ...
    def doMission(self):
        ...
        if sType == "MISSION_MOVE_TO_UNIT":
            ...
            iData2 = self.top.iTargetPlotY
        pTargetPlot = GlobalCyMap.plot(self.top.iTargetPlotX, self.top.iTargetPlotY)
    ...
    def changeOwner(self, iPlayer):
        pNewUnit = gcgetPlayer(iPlayer).initUnit(pUnit.getUnitType(), pUnit.getX(), pUnit.getY(), UnitAITypes.NO_UNITAI, DirectionTypes.NO_DIRECTION)
    ...
    def changeUnitType(self, pUnit, iUnitType, bUnitType):
        if bUnitType:
            pNewUnit = gcgetPlayer(pUnit.getOwner()).initUnit(iUnitType, pUnit.getX(), pUnit.getY(), UnitAITypes.NO_UNITAI, DirectionTypes.NO_DIRECTION)
            pNewUnit.convert(pUnit)
    ...
    def handleCopyAll(self):
        for i in lUnits:
            loopUnit = gcgetPlayer(i[0]).getUnit(i[1])
