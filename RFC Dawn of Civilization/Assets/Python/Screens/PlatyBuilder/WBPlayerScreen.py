...
class WBPlayerScreen:
    ...
    def interfaceScreen(self, iPlayerX):
        ...
        screen.setText("PlayerExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_PLAYER_DATA", ()), 0, 0, True)
    ...
    def placeStats(self):
        ...
        if len(lTraits):
            ...
            for iTrait in xrange(len(lTraits)):
                sText += GlobalCyTranslator.getText(gc.getTraitInfo(lTraits[iTrait]).getShortDescription(), ())
        ...
        screen.setLabel("CivilizationName", "Background", "<font=4b>" + pPlayer.getCivilizationDescription(0) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() / 2, 50, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL,
                        -1, -1)
        ...
        sText = u"%s %s%c" % (GlobalCyTranslator.getText("TXT_KEY_WB_GOLD", ()), CvPlatyBuilderScreen.CvWorldBuilderScreen().addComma(pPlayer.getGold()), gc.getCommerceInfo(CommerceTypes.COMMERCE_GOLD).getChar())
        ...
        sText = u"%s: %d/%d" % (GlobalCyTranslator.getText("TXT_KEY_MISC_COMBAT_EXPERIENCE", ()), pPlayer.getCombatExperience(), pPlayer.greatPeopleThreshold(True))
        ...
        sText = u"%s: %d" % (GlobalCyTranslator.getText("TXT_KEY_CONCEPT_GOLDEN_AGE", ()), pPlayer.getGoldenAgeTurns())
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_GOLDEN_AGE_UNITS", (pPlayer.unitsRequiredForGoldenAge(),))
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_ANARCHY", (pPlayer.getAnarchyTurns(),))
        ...
        sText = GlobalCyTranslator.getText("TXT_KEY_WB_COASTAL_TRADE", (pPlayer.getCoastalTradeRoutes(),))
        ...
        for i in xrange(CommerceTypes.NUM_COMMERCE_TYPES):
            ...
            sText = sColor + u"<font=3>%c: %d%% %s</color></font>" % (gc.getCommerceInfo(i).getChar(), pPlayer.getCommercePercent(i), GlobalCyTranslator.getText("TXT_KEY_MISC_POS_GOLD_PER_TURN", (pPlayer.getCommerceRate(CommerceTypes(i)),)))
        ...
        if iPlayer in lSecondaryCivs:
            if data.isPlayerEnabled(iPlayer):
                ...
                screen.setButtonGFC("CivEnabledButton", "", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(), iX, iY, 64, 64, WidgetTypes.WIDGET_PYTHON, 22001, 1, ButtonStyles.BUTTON_STYLE_STANDARD)
    ...
    def placeResearch(self):
        ...
        sCurrentTech = GlobalCyTranslator.getText("TXT_KEY_CULTURELEVEL_NONE", ())
        screen.setTableText("WBPlayerResearch", 0, 0, "<font=3>" + sColor + sCurrentTech + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(), WidgetTypes.WIDGET_PYTHON, 7871, -1,
    ...
    def placeModifiers(self, bRevert=False):
        ...
        if not bRevert:
            screen.setButtonGFC("ModifierResetButton", GlobalCyTranslator.getText("TXT_KEY_WB_REVERT_CHANGES", ()), "", iXxx, iY - 40, iWidth2, 35, WidgetTypes.WIDGET_GENERAL, 1, -1, ButtonStyles.BUTTON_STYLE_STANDARD)
        else:
    ...
    def placeReligions(self):
        ...
        screen.setLabel("ReligionsHeader", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_RELIGION", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, iX + iWidth / 2, iY, -0.1, FontTypes.TITLE_FONT,
        ...
        screen.setTableText("WBPlayerReligions", 0, 0, "<font=3>" + sColor + GlobalCyTranslator.getText("TXT_KEY_CULTURELEVEL_NONE", ()) + "</font></color>", GlobalCyArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(),
                            WidgetTypes.WIDGET_HELP_RELIGION, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_STATE_RELIGION_UNIT", (pPlayer.getStateReligionUnitProductionModifier(),)) + "</font>"
        ...
        sText = "<font=3>" + GlobalCyTranslator.getText("TXT_KEY_WB_STATE_RELIGION_BUILDING", (pPlayer.getStateReligionBuildingProductionModifier(),)) + "</font>"
    ...
    def placeCivics(self):
        ...
        screen.setLabel("CivicsHeader", "Background", "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_CIVIC", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, iX + iWidth / 2, iY, -0.1, FontTypes.TITLE_FONT,
                        WidgetTypes.WIDGET_GENERAL, -1, -1)
        ...
        for iCivicOption in xrange(gc.getNumCivicOptionInfos()):
            ...
            if iRow > iMaxRow:
                ...
                iMaxRow = iRow
            sText = "<font=3>" + GlobalCyTranslator.getText("[COLOR_HIGHLIGHT_TEXT]", ()) + gc.getCivicOptionInfo(iCivicOption).getDescription() + "</font></color>"
    ...
    def handleInput(self, inputClass):
        ...
        if inputClass.getFunctionName() == "ChangeBy":
            ...
            screen.setLabel("CivilizationName", "Background", "<font=4b>" + pPlayer.getCivilizationDescription(0) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() / 2, 50, -0.1, FontTypes.GAME_FONT,
                            WidgetTypes.WIDGET_GENERAL, -1, -1)
