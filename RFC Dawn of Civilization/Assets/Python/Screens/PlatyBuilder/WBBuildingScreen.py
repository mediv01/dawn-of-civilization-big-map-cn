...
class WBBuildingScreen:
    ...
    def interfaceScreen(self, pCityX):
        ...
        screen.setLabel("BuildingHeader", "Background", u"<font=4b>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_BUILDING", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() * 5 / 8 - 10,
                        screen.getYResolution() / 2 + 5, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
        screen.setLabel("WonderHeader", "Background", u"<font=4b>" + GlobalCyTranslator.getText("TXT_KEY_CONCEPT_WONDERS", ()) + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() * 5 / 8 - 10, 20, -0.1, FontTypes.TITLE_FONT,
                        WidgetTypes.WIDGET_GENERAL, -1, -1)
        sText = GlobalCyTranslator.getText("[COLOR_SELECTED_TEXT]", ()) + "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_GRANT_AVAILABLE", ()) + "</color></font>"
        ...
        screen.setText("WBBuildingExit", "Background", "<font=4>" + GlobalCyTranslator.getText("TXT_KEY_PEDIA_SCREEN_EXIT", ()).upper() + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 30, screen.getYResolution() - 42, -0.1,
        ...
        screen.addPullDownString("WonderClass", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ALL", ()), 0, 0, iSelectedClass == 0)
        screen.addPullDownString("WonderClass", GlobalCyTranslator.getText("TXT_KEY_PEDIA_NATIONAL_WONDER", ()), 1, 1, iSelectedClass == 1)
        screen.addPullDownString("WonderClass", GlobalCyTranslator.getText("TXT_KEY_PEDIA_TEAM_WONDER", ()), 2, 2, iSelectedClass == 2)
        screen.addPullDownString("WonderClass", GlobalCyTranslator.getText("TXT_KEY_PEDIA_WORLD_WONDER", ()), 3, 3, iSelectedClass == 3)
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_BUILDING", ()), 2, 2, True)
        ...
        sText = "<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_COPY_ALL", (GlobalCyTranslator.getText("TXT_KEY_CONCEPT_CITIES", ()),)) + "</font>"
        sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
        if bApplyAll:
            sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
        ...
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_MODIFY", ("",)), 2, 2, 2 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_ADD", ()), 1, 1, 1 == iChangeType)
        screen.addPullDownString("ChangeType", GlobalCyTranslator.getText("TXT_KEY_WB_CITY_REMOVE", ()), 0, 0, 0 == iChangeType)
    ...
    def handleInput(self, inputClass):
        ...
        if inputClass.getFunctionName() == "CurrentPage":
            ...
            bUpdate = self.editBuilding(inputClass.getData1(), gcgetPlayer(iPlayer), False, False)
            self.placeBuildings()
            if bUpdate:
                self.placeWonders()
            ...
            for item in lBuilding:
                bTemp = self.editBuilding(item[1], gcgetPlayer(iPlayer), True, False)
            ...
            bUpdate = False
            for item in lBuilding:
                bTemp = self.editBuilding(item[1], gcgetPlayer(iPlayer), False, False)
                bUpdate = bUpdate or bTemp
            self.placeBuildings()
            if bUpdate:
                self.placeWonders()
            ...
            bUpdate = self.editBuilding(inputClass.getData1(), gcgetPlayer(iPlayer), False, True)
            self.placeWonders()
            ...
            if iSelectedClass == 0:
                ...
                lList = lTeam
            for item in lList:
                bTemp = self.editBuilding(item[1], gcgetPlayer(iPlayer), True, True)
                bUpdate = bUpdate or bTemp
            self.placeWonders()
            if bUpdate:
                self.placeBuildings()
            ...
            if iSelectedClass == 0:
                ...
                lList = lTeam
            for item in lList:
                bTemp = self.editBuilding(item[1], gcgetPlayer(iPlayer), False, True)
                bUpdate = bUpdate or bTemp
            self.placeWonders()
            if bUpdate:
                self.placeBuildings()
            ...
            sText = u"<font=3b>" + GlobalCyTranslator.getText("TXT_KEY_WB_COPY_ALL", (GlobalCyTranslator.getText("TXT_KEY_CONCEPT_CITIES", ()),)) + "</font>"
            sColor = GlobalCyTranslator.getText("[COLOR_WARNING_TEXT]", ())
            if bApplyAll:
                sColor = GlobalCyTranslator.getText("[COLOR_POSITIVE_TEXT]", ())
