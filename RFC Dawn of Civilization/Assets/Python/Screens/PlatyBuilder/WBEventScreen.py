...
class WBEventScreen:
    ...
    def interfaceScreen(self, pPlotX):
        ...
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_WB_PLOT_DATA", ()), 0, 0, False)
        screen.addPullDownString("CurrentPage", GlobalCyTranslator.getText("TXT_KEY_CONCEPT_EVENTS", ()), 1, 1, True)
        if pPlot.isOwned():
    ...
    def placeEventPlayers(self):
        ...
        for iPlayerX in xrange(gc.getMAX_CIV_PLAYERS()):
            ...
            if pPlayerX.isAlive():
                ...
                screen.setTableText("WBEventPlayer", 1, iRow, "<font=3>" + sColor + pPlayerX.getName() + "</font></color>", gc.getLeaderHeadInfo(iLeader).getButton(), WidgetTypes.WIDGET_PYTHON, 7876, iPlayerX * 10000 + iLeader,
    ...
    def placeUnits(self):
        ...
        sHeader = GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ())
        nColumns = 3
    ...
    def placeCorporations(self):
        ...
        sHeader = GlobalCyTranslator.getText("TXT_KEY_CONCEPT_CORPORATIONS", ())
        ...
        screen.setLabel("EventCorporationText", "Background", "<font=3b>" + sHeader + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() * 7 / 10, screen.getYResolution() / 2, -0.1, FontTypes.TITLE_FONT,
    ...
    def placeReligions(self):
        ...
        sHeader = GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_RELIGION", ())
        ...
        screen.setLabel("EventReligionText", "Background", "<font=3b>" + sHeader + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() / 2, screen.getYResolution() / 2, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1,
                        -1)
    ...
    def placeBuildings(self):
        ...
        sHeader = GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_BUILDING", ())
        ...
        screen.setLabel("EventBuildingText", "Background", "<font=3b>" + sHeader + "</font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution() * 3 / 10, screen.getYResolution() / 2, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL,
                        -1, -1)
    ...
    def placeOtherCities(self):
        ...
        sHeader = GlobalCyTranslator.getText("TXT_KEY_WB_CITY", ()) + " II"
        ...
        (loopCity, iter) = gcgetPlayer(iOtherPlayer).firstCity(False)
        while (loopCity):
            ...
            (loopCity, iter) = gcgetPlayer(iOtherPlayer).nextCity(iter, False)
    ...
    def placeOtherPlayers(self):
        ...
        sHeader = GlobalCyTranslator.getText("TXT_KEY_MAIN_MENU_PLAYER", ()) + " II"
        ...
        for iPlayerX in xrange(gc.getMAX_CIV_PLAYERS()):
            ...
            if pPlayerX.isAlive():
                ...
                screen.setTableText("WBOtherPlayer", 1, iRow, "<font=3>" + sColor + pPlayerX.getName() + "</font></color>", gc.getLeaderHeadInfo(iLeader).getButton(), WidgetTypes.WIDGET_PYTHON, 7876, iPlayerX * 10000 + iLeader,
                                    CvUtil.FONT_LEFT_JUSTIFY)
    ...
    def placeEvents(self):
        ...
        sHeader = GlobalCyTranslator.getText("TXT_KEY_CONCEPT_EVENTS", ())
        ...
        if iSelectedEvent > -1:
            sText = "<font=4b>" + GlobalCyTranslator.getText("[COLOR_BLACK]", ()) + GlobalCyTranslator.getText("TXT_KEY_WB_TRIGGER_EVENT", (sHeader,)).upper() + "</color></font>"
        ...
        if inputClass.getFunctionName() == "CurrentPage":
            ...
            if iIndex == 0:
                ...
                if iSelectedUnit > -1 and iEventPlayer > -1:
                    pUnit = gcgetPlayer(iEventPlayer).getUnit(iSelectedUnit)
                else:
            ...
            pPlayer = gcgetPlayer(iEventPlayer)
            iCity = -1
            if pPlot.isCity():
