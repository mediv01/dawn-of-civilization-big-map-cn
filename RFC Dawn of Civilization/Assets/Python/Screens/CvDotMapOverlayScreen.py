...
class CvDotMapOverlayScreen:
    ...
    def hideScreen(self):
        ...
        GlobalCyInterface.setInterfaceMode(InterfaceModeTypes.INTERFACEMODE_SELECTION)
    ...
    def update(self, fDelta):
        ...
        if GlobalCyInterface.isLeftMouseDown():
            ...
            self.bLeftMouseDown = False
        if GlobalCyInterface.isRightMouseDown():
    ...
    def onMouseOverPlot(self, argsList=None):
        ...
        """
        plot = GlobalCyInterface.getMouseOverPlot()
        x = plot.getX()
        y = plot.getY()
    ...
    def resetInterfaceMode(self):
        if GlobalCyInterface.getInterfaceMode() != InterfaceModeTypes.INTERFACEMODE_PYTHON_PICK_PLOT:
            GlobalCyInterface.setInterfaceMode(InterfaceModeTypes.INTERFACEMODE_PYTHON_PICK_PLOT)
