...
class PLE:
    ...
    def updatePlotListButtons_PLE(self, screen, xResolution, yResolution):
        ...
        self.pActPlot = GlobalCyInterface.getSelectionPlot()
        ...
        if (self.pActPlot and GlobalCyInterface.getShowInterface() != InterfaceVisibility.INTERFACE_HIDE_ALL and CyEngine().isGlobeviewUp() == False):

            nRow = 0
            nCol = 0
            self.iVisibleUnits = GlobalCyInterface.getNumVisibleUnits()
    ...
    def resetPLEFilters(self):
        self.nPLEFilter = self.nPLEAllFilters
        GlobalCyInterface.setDirty(InterfaceDirtyBits.PlotListButtons_DIRTY_BIT, True)
    ...
    def showPlotListButtonObjects(self, screen):
        if (
                PleOpt.isShowButtons() and GlobalCyInterface.getShowInterface() != InterfaceVisibility.INTERFACE_HIDE_ALL and GlobalCyInterface.getShowInterface() != InterfaceVisibility.INTERFACE_MINIMAP_ONLY and GlobalCyInterface.getShowInterface() != InterfaceVisibility.INTERFACE_ADVANCED_START):
    ...
    def preparePlotListObjects(self, screen):
        ...
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_GRP_UNITTYPE").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1,
                              -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)

        # place the promotion and upgrades mode switches
        nXOff += nDist
        szString = self.PLE_GRP_PROMO
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_GRP_PROMO").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1, -1,
                              ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)

        nXOff += nDist
        szString = self.PLE_GRP_UPGRADE
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_GRP_UPGRADE").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1, -1,
                              ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)
        ...
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_CANMOVE").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1,
                              -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)

        nXOff += nDist
        szString = self.PLE_FILTER_CANTMOVE
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_CANTMOVE").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1,
                              -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)
        ...
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_NOTWOUND").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1,
                              -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)

        nXOff += nDist
        szString = self.PLE_FILTER_WOUND
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_WOUND").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1,
                              -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)
        ...
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_LAND").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1, -1,
                              ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)

        nXOff += nDist
        szString = self.PLE_FILTER_SEA
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_SEA").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1, -1,
                              ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)

        nXOff += nDist
        szString = self.PLE_FILTER_AIR
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_AIR").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1, -1,
                              ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)
        ...
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_MIL").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1, -1,
                              ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)

        nXOff += nDist
        szString = self.PLE_FILTER_DOM
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_DOM").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1, -1,
                              ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)
        ...
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_OWN").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1, -1,
                              ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)

        nXOff += nDist
        szString = self.PLE_FILTER_FOREIGN
        screen.addCheckBoxGFC(szString, ArtFileMgr.getInterfaceArtInfo("PLE_FILTER_FOREIGN").getPath(), ArtFileMgr.getInterfaceArtInfo("PLE_BUTTON_HILITE").getPath(), nXOff, yResolution - nYOff, nSize, nSize, WidgetTypes.WIDGET_GENERAL, 1,
                              -1, ButtonStyles.BUTTON_STYLE_LABEL)
        screen.hide(szString)
    ...
    def deselectAll(self):
        for i in range(len(self.lPLEUnitList)):
            ...
            if (pUnit.IsSelected()):
                GlobalCyInterface.selectUnit(pUnit, False, True, False)
    ...
    def getTempPlot(self):
        ...
        if not (self.pActPlot.isCity()):
            ...
            for dx in range(-1, 2):
                for dy in range(-1, 2):
                    if dx != 0 and dy != 0:
                        pPlot = GlobalCyMap.plot(pCapital.getX() + dx, pCapital.getY() + dy)
                        lList.append(pPlot)
            for d in range(DomainTypes.NUM_DOMAIN_TYPES):
                dPlotList[d] = lList[d]
        return dPlotList
    ...
    def selectGroup(self, iID, bShift, bCtrl, bAlt):
        ...
        bCityUp = GlobalCyInterface.isCityScreenUp()
        if not (self.pActPlotListUnit):
            self.pActPlotListUnit = GlobalCyInterface.getHeadSelectedUnit()
        ...
        if (not (bShift or bCtrl or bAlt)):
            ...
            GlobalCyInterface.selectGroup(self.pActPlotListUnit, False, False, False)
        ...
        #					GlobalCyInterface.selectUnit(self.pLastPlotListUnit, False, True, False)
        #			# check if the group has not been changed and the unit is selected again -> deselect all other units of the group
        #			if (self.iLastPlotListGroup == self.iActPlotListGroup):
        #				GlobalCyInterface.selectUnit(self.pActPlotListUnit, True, True, True)
        #			else:
        #				GlobalCyInterface.selectUnit(self.pActPlotListUnit, False, True, True)
        elif bShift and (not (bCtrl or bAlt)):
            self.pActPlotListUnit = pUnit
            self.iActPlotListGroup = pUnit.getGroupID()
            #			GlobalCyInterface.selectUnit(self.pActPlotListUnit, False, True, True)
            GlobalCyInterface.selectGroup(self.pActPlotListUnit, True, False, False)
            ...
            self.tempMove(0)
            GlobalCyInterface.selectGroup(self.pActPlotListUnit, False, True, False)
            self.tempMove(1)
            self.setPLEUnitList(True)
            ...
            self.tempMove(0)
            GlobalCyInterface.selectGroup(self.pActPlotListUnit, True, True, False)
            self.tempMove(1)
            self.setPLEUnitList(True)
            ...
            self.tempMove(0)
            GlobalCyInterface.selectGroup(self.pActPlotListUnit, False, False, True)
            self.tempMove(1)
            self.setPLEUnitList(True)
        ...
        if (self.isPLEFilter(self.nPLEAllFilters)):
            ...
            if (PleOpt.isPleFilterBehavior()):
                ...
                if (self.isPLEFilter(self.nPLEFilterModeOwn)):
                    if (pUnit.getOwner() == gcgame.getActivePlayer()):
                        return False
                # # is the units owner another player
                if (self.isPLEFilter(self.nPLEFilterModeForeign)):
                    if (not (pUnit.getOwner() == gcgame.getActivePlayer())):
                        return False
            else:
                # BUG Filter Mode
                if (self.isPLEFilter(self.nPLEFilterModeCanMove)):
    ...
    def getPLEUnitInfo(self, pUnit):
        if pUnit.isCargo() and (self.nPLEGrpMode != self.PLE_GRP_PROMO) and (self.nPLEGrpMode != self.PLE_GRP_UPGRADE):
            ...
            tReturn = (
                setUnit[self.IDX_PLAYER], setUnit[self.IDX_DOMAIN], setUnit[self.IDX_GROUPID], setUnit[self.IDX_COMBAT], setUnit[self.IDX_UNITTYPE], setUnit[self.IDX_LEVEL], setUnit[self.IDX_XP], pTransportUnit.getID(), pUnit.getID(),
                pUnit.getID(), pUnit)
            return tReturn
        else:
    ...
    def getUnitList(self, pPlot):
        ...
        for i in range(pPlot.getNumUnits()):
            ...
            if not pUnit.isInvisible(gcgetPlayer(gcgame.getActivePlayer()).getTeam(), True):
    ...
    def showPromoInfoPane(self, id):
        ...
        # promo info
        szPromoInfo = u"<font=2>" + mt.removeLinks(GlobalCyGameTextMgr.getPromotionHelp(iPromo, False)) + u"</font>\n"
    ...
    def showUpgradeInfoPane(self, id):
        ...
        szStrength = u"%i " % iStrength + u"%c" % GlobalCyGame.getSymbolID(FontSymbols.STRENGTH_CHAR)
        szMovement = u", %i " % pUnitTypeInfo.getMoves() + u"%c" % GlobalCyGame.getSymbolID(FontSymbols.MOVES_CHAR)
        if (pUnitTypeInfo.getAirRange() > 0):
            szRange = u", " + localText.getText("TXT_KEY_UNIT_AIR_RANGE", (pUnitTypeInfo.getAirRange(),)) + u"\n"
        else:
            szRange = u"\n"
        szSpecialText = mt.removeLinks(GlobalCyGameTextMgr.getUnitHelp(iUnitType, True, False, False, None)[1:]) + "\n"
    ...
    def showUnitInfoPane(self, id):
        ...
        if (pUnit.getOwner() != gcgame.getActivePlayer()):
            pOwner = gcgetPlayer(pUnit.getOwner())
        ...
        if fCurrStrength != fMaxStrength:
            ...
            szMaxStrength = u""
            szTurnsToHeal = u""
        szStrength = u"<font=2>" + szCurrStrength + szMaxStrength + szTurnsToHeal + u"%c" % GlobalCyGame.getSymbolID(FontSymbols.STRENGTH_CHAR) + u"</font>\n"
        ...
        if (pUnit.movesLeft() != iMaxMoves * gc.getMOVE_DENOMINATOR()):
            ...
            szMaxMoves = u""
        szMovement = u"<font=2>" + szCurrMoves + szMaxMoves + u"%c" % (GlobalCyGame.getSymbolID(FontSymbols.MOVES_CHAR)) + szAirRange + u"</font>\n"

        # compressed display for standard display
        szStrengthMovement = u"<font=2>" + szCurrStrength + szMaxStrength + szTurnsToHeal + u"%c" % GlobalCyGame.getSymbolID(FontSymbols.STRENGTH_CHAR) + ", " + \
                             szCurrMoves + szMaxMoves + u"%c" % (GlobalCyGame.getSymbolID(FontSymbols.MOVES_CHAR)) + szAirRange + u"</font>\n"

        # civilization type
        szCiv = u""
        #		iCiv = pUnit.getCivilizationType()
        #		for i in range(gc.getMAX_PLAYERS()):
        #			pLoopPlayer = gcgetPlayer(i)
    ...
    def getTextLines(self, szText):
        ...
        sComp = u"%c" % GlobalCyGame.getSymbolID(FontSymbols.BULLET_CHAR)
        for i in range(len(lChapters)):
            iLen = len(lChapters[i])
            iWidth = GlobalCyInterface.determineWidth(lChapters[i]) / (self.CFG_INFOPANE_DX - 3) + 1
    ...
    def displayInfoPane(self, szText):
        ...
        self.iInfoPaneCnt += 1
        self.tLastMousePos = (GlobalCyInterface.getMousePos().x, GlobalCyInterface.getMousePos().y)
