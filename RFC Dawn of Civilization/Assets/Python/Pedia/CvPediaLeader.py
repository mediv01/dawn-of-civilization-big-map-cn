...
class CvPediaLeader:
    ...
    def placeTraits(self):
        ...
        screen.addPanel(panel, GlobalCyTranslator.getText("TXT_KEY_PEDIA_TRAITS", ()), "", True, False, self.X_TRAITS, self.Y_TRAITS, self.W_TRAITS, self.H_TRAITS, PanelStyles.PANEL_STYLE_BLUE50)
        ...
        szTraitText = GlobalCyGameTextMgr.parseLeaderTraits(self.iLeader, iLeaderCiv, False, True).replace("<color=127,255,25,255>", "\n<color=127,255,25,255>").strip()
    ...
    def placeFavorites(self):
        screen = self.top.getScreen()
        panel = self.top.getNextWidgetName()
        screen.addPanel(panel, GlobalCyTranslator.getText("TXT_KEY_PEDIA_FAVOURITES", ()), "", False, True, self.X_FAVORITES, self.Y_FAVORITES, self.W_FAVORITES, self.H_FAVORITES, PanelStyles.PANEL_STYLE_BLUE50)
