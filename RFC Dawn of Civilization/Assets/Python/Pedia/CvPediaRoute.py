...
class CvPediaRoute:
    ...
    def placeImprovements(self):
        ...
        screen.addPanel(panel, GlobalCyTranslator.getText("TXT_KEY_CONCEPT_IMPROVEMENTS", ()), "", True, True, self.X_IMPROVEMENTS, self.Y_IMPROVEMENTS, self.W_IMPROVEMENTS, self.H_IMPROVEMENTS, PanelStyles.PANEL_STYLE_BLUE50)
