...
class CvPediaFeature:
    ...
    def placeInfo(self):
        ...
        szText = ""
        screen.appendListBoxString(panel, GlobalCyTranslator.getText("TXT_KEY_PEDIA_TERRAIN_FEATURE", ()), WidgetTypes.WIDGET_GENERAL, 0, 0, CvUtil.FONT_LEFT_JUSTIFY)
    ...
    def placeDetails(self):
        ...
        szText = info.getHelp()
        szText += GlobalCyGameTextMgr.getFeatureHelp(self.iFeature, True)
        ...
        if self.bNaturalWonder:
            ...
            if iBuilding != -1:
                szText += GlobalCyGameTextMgr.getBuildingHelp(iBuilding, True, False, False, None)  # [1:]
    ...
    def placeTerrain(self):
        ...
        screen.addPanel(panel, GlobalCyTranslator.getText("TXT_KEY_PEDIA_TERRAIN", ()), "", False, True, self.X_FEATURES, self.Y_FEATURES, self.W_FEATURES, self.H_FEATURES, PanelStyles.PANEL_STYLE_BLUE50)
    ...
    def placeImprovements(self):
        ...
        screen.addPanel(panel, GlobalCyTranslator.getText("TXT_KEY_PEDIA_CATEGORY_IMPROVEMENT", ()), "", False, True, self.X_IMPROVEMENTS, self.Y_IMPROVEMENTS, self.W_IMPROVEMENTS, self.H_IMPROVEMENTS, PanelStyles.PANEL_STYLE_BLUE50)
        screen.attachLabel(panel, "", "  ")
