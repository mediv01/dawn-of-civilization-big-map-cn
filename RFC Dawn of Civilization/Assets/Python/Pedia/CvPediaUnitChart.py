    ...
    def placeUnitTable(self):
        ...
        for iUnit in xrange(gc.getNumUnitInfos()):
            ...
            if self.iGroup == UnitInfo.getUnitCombatType():
                ...
                elif UnitInfo.getFirstStrikes() > 0 and not (
                        self.iGroup == gc.getInfoTypeForString('UNITCOMBAT_AIR') or self.iGroup == gc.getInfoTypeForString('UNITCOMBAT_NAVAL') or self.iGroup == gc.getInfoTypeForString('UNITCOMBAT_SIEGE')):
                ...
                if UnitInfo.getProductionCost() < 0:
                    szCost = GlobalCyTranslator.getText("TXT_KEY_NON_APPLICABLE", ())
                else:
