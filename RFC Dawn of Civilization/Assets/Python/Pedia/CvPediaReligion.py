...
class CvPediaReligion:
    ...
    def placeInfo(self):
        ...
        screen.addDDSGFC(self.top.getNextWidgetName(), ReligionInfo.getButton(), self.X_ICON + self.W_ICON / 2 - self.ICON_SIZE / 2, self.Y_ICON + self.H_ICON / 2 - self.ICON_SIZE / 2, self.ICON_SIZE, self.ICON_SIZE,
    ...
    def placeEffects(self):
        ...
        szSpecialText = GlobalCyGameTextMgr.parseReligionInfo(self.iReligion, True)
