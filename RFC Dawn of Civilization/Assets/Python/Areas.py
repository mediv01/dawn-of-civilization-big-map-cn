...
def getRespawnArea(iPlayer):
    ...
    if (PYTHON_ONLY_RESPAWN_IN_CORE == 1):
...
def isExtendedBirth(iPlayer):
    if gcgame.getActivePlayer() == iPlayer: return False
...
dChangedBirthArea = {
    ...
    iGreece: ((74, 48), (78, 54)),  # excludes Istanbul and Izmir
    iPersia: ((84, 43), (98, 55)),  # includes Assyria and Anatolia
    iArabia: ((74, 35), (90, 50)),  # Arabia
    iSpain: ((53, 51), (61, 54)),  # includes Catalonia and Galicia
...
dBirthAreaExceptions = {
    ...
    iChina: [(118, 41), (118, 42), (118, 43), (119, 41), (119, 42), (120, 41), (120, 42), (121, 41), (121, 42), (122, 41), (122, 42)], 
    iGreece: [(74, 54), (74, 53)],
    ...
    iRome: [(72, 56), (72, 57)],
    iArabia: [(74, 50), (75, 49), (75, 50), (77, 35), (77, 36), (77, 37), (77, 38), (77, 39), (77, 48), (78, 35), (78, 36), (78, 37), (78, 38), (78, 48), (78, 49), (78, 50), (79, 35), (79, 36), (79, 37), (79, 38), (79, 48), (79, 49),
              (79, 50), (80, 35), (80, 36), (80, 37), (80, 38), (80, 48), (80, 49), (80, 50), (81, 35), (81, 36), (81, 37), (81, 38), (81, 48), (81, 49), (81, 50), (82, 35), (82, 36), (82, 37), (82, 38), (82, 48), (82, 49), (82, 50),
              (83, 35), (83, 36), (83, 37), (83, 38), (83, 49), (83, 50), (84, 35), (84, 36), (84, 37), (84, 38), (84, 49), (84, 50), (85, 35), (85, 36), (85, 37), (85, 49), (85, 50), (86, 35), (86, 49), (86, 50)],
    iTibet: [(107, 47), (108, 47)],
    iSpain: [(53, 51), (53, 52), (54, 51), (54, 52), (55, 51), (55, 52)], #excludes Lusitania
    ...
    iMongolia: [(120, 53), (121, 53), (121, 54), (122, 53), (122, 54), (123, 53), (123, 54), (123, 55), (123, 56), (124, 53), (124, 54), (124, 55), (124, 56), (125, 53), (125, 54), (125, 55), (125, 56), (126, 53), (126, 54), (126, 55),
                (126, 56), (127, 53), (127, 54), (127, 55), (127, 56), (128, 53), (128, 54), (128, 55), (128, 56), (129, 53), (129, 54), (129, 55), (129, 56), (130, 53), (130, 54), (130, 55), (130, 56), (130, 57), (131, 53), (131, 54),
                (131, 55), (131, 56), (131, 57), (131, 58)],
    iOttomans: [(79, 54), (79, 55), (80, 54), (80, 55), (81, 55), (82, 55)],
    iNetherlands: [(61, 62), (64, 62), (64, 63)],
    iGermany: [(69, 59), (69, 60), (69, 61), (69, 62), (70, 59), (70, 60), (70, 61), (70, 62), (71, 59), (71, 60), (71, 61), (71, 62), (72, 59), (72, 60), (72, 61), (72, 62), (73, 59), (73, 60), (73, 61), (73, 62), (74, 59), (74, 60),
               (74, 61), (74, 62), (74, 63), (74, 64), (75, 59), (75, 60), (75, 61), (75, 62), (75, 63), (75, 64), (76, 59), (76, 60), (76, 61), (76, 62), (76, 63), (76, 64)],
    iAmerica: [(25, 59), (26, 59), (27, 59), (28, 59), (29, 59)],
    iBrazil: [(36, 15), (36, 16)],
    iCanada: [(18, 59), (18, 60), (18, 61), (19, 59), (19, 60), (19, 61), (20, 59), (20, 60), (20, 61), (21, 59), (21, 60), (21, 61), (22, 59), (22, 60), (23, 59), (23, 60), (24, 59), (24, 60), (30, 59), (31, 59), (32, 59), (33, 59),
              (33, 60), (34, 59), (34, 60)],
}
...
dCoreAreaExceptions = {
    ...
    iManchuria: [(123, 62), (123, 63), (123, 64), (123, 65), (124, 63), (124, 64), (124, 65), (125, 63), (125, 64), (125, 65), (126, 64), (126, 65), (128, 52), (130, 55), (130, 56), (130, 57), (130, 64), (130, 65), (131, 52), (131, 53), (131, 54), (131, 55), (131, 56), (131, 57), (131, 58), (131, 64), (131, 65), (132, 52), (132, 53), (132, 54), (132, 55), (132, 56), (132, 57), (132, 58), (132, 59), (132, 60), (132, 63), (132, 64), (132, 65)],
...
dChangedCoreAreaExceptions = {
    ...
    iMoors: [(57, 48)],
    iSpain: [(53, 49), (53, 50), (53, 51), (53, 52), (54, 49), (54, 50), (54, 51), (54, 52), (55, 49), (55, 50), (55, 51), (55, 52), (62, 48)],
