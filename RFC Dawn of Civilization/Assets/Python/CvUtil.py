...
import pp  # wunshare: for speed up
...
#		combatMessage += "%s's" %(gc.getPlayer(cdAttacker.eOwner).getName(),)
		combatMessage += "%s%s" %(gc.getPlayer(cdAttacker.eOwner).getName(),localText.getText("TXT_KEY_APOSTROPHE_S", ()),)
# <<< CYBERFRONT
...
#		combatMessage += "%s's" %(gc.getPlayer(cdDefender.eOwner).getName(),)
		combatMessage += "%s%s" %(gc.getPlayer(cdDefender.eOwner).getName(),localText.getText("TXT_KEY_APOSTROPHE_S", ()),)
# <<< CYBERFRONT
