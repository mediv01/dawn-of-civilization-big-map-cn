...
def initTechPreferences(iPlayer, dPreferences):
    for iTech, iValue in dPreferences.items():
        gcgetPlayer(iPlayer).setTechPreference(iTech, iValue)
...
def initBirthYear(iPlayer):
    gcgetPlayer(iPlayer).setBirthYear(tBirth[iPlayer])
...
lStartingTechs = [
    {
        ...
        iCivAssyria: Techs([iTanning, iMining, iAgriculture, iPastoralism, iPottery, iAlloys, iSmelting, iLeverage]),
        iCivChina: Techs([iTanning, iMining, iAgriculture, iPastoralism, iPottery, iMythology, iSmelting, iLeverage]),
        iCivHittites: Techs([iTanning, iMining, iAgriculture, iPastoralism, iPottery, iMythology, iSmelting, iLeverage]),
        ...
        iCivArmenia: Techs(column=5, exceptions=[iPolitics, iEngineering, iCurrency, iPhilosophy]),
        ...
        iCivChalukya: Techs([iNobility, iSteel, iFeudalism, iPolitics, iGuilds], column=5),
        ...
        iCivScotland: Techs([iFeudalism, iTheology, iFortification], column=6, exceptions=[iArtisanry]),
        ...
        iCivTatar: Techs([iCommune, iCropRotation, iDoctrine, iGunpowder], column=7),
        ...
        iCivManchuria: Techs([iCombinedArms], column=10, exceptions=[iExploration, iOptics, iAcademia, iHumanities]),
    ...
    },
    {
        ...
        iCivRome: Techs([iFeudalism], column=6, exceptions=[iArtisanry]),
        ...
        iCivChalukya: Techs([iArtisanry, iFeudalism], column=5, exceptions=[iGeneralship, iPhilosophy]),
    ...
    },
    {
        ...
        iCivNubia: Techs([iCartography, iJudiciary], column=8),
        iCivManchuria: Techs([iHorticulture, iCombinedArms], column=10, exceptions=[iExploration, iOptics, iAcademia, iHumanities]),
        iCivIndia: Techs([iCombinedArms, iUrbanPlanning], column=10, exceptions=[iExploration, iOptics, iHeritage, iLogistics]),
        iCivEthiopia: Techs([iGeography], column=10, exceptions=[iExploration, iOptics, iHeritage, iLogistics]),
        iCivTamils: Techs([iCombinedArms, iUrbanPlanning], column=10, exceptions=[iExploration, iOptics, iHeritage, iLogistics]),
        ...
        iCivVietnam: Techs(column=10, exceptions=[iExploration, iOptics, iAcademia]),
        iCivArmenia: Techs([iFirearms, iLogistics, iHeritage], column=9),
        ...
        iCivBurma: Techs([iUrbanPlanning], column=10, exceptions=[iExploration, iOptics, iHeritage, iLogistics]),
        iCivKhmer: Techs([iUrbanPlanning], column=10, exceptions=[iExploration, iOptics, iHeritage, iLogistics]),
        iCivPhilippines: Techs([iFirearms, iLogistics, iHeritage], column=9),
        ...
        iCivFrance: Techs(column=11, exceptions=[iEconomics]),
        iCivOman: Techs([iGeography], column=10, exceptions=[iHeritage]),
        iCivEngland: Techs(column=11, exceptions=[iEconomics]),
        iCivHolyRome: Techs([iCombinedArms, iUrbanPlanning, iHorticulture, iGeography], column=10),
        ...
        iCivMali: Techs([iCartography, iJudiciary], column=8),
        iCivTibet: Techs([iCartography, iJudiciary], column=8),
        iCivIndonesia: Techs([iCartography, iJudiciary], column=8),
        iCivNigeria: Techs([iCartography, iJudiciary], column=8),
        iCivYemen: Techs([iCartography, iJudiciary], column=8),
        iCivMongols: Techs([iFirearms, iLogistics, iHeritage], column=9),
        iCivOttomans: Techs([iUrbanPlanning, iHorticulture], column=10, exceptions=[iExploration, iOptics]),
        ...
        iCivSweden: Techs(column=11, exceptions=[iEconomics, iScientificMethod]),
        iCivNetherlands: Techs(column=11, exceptions=[iEconomics, iScientificMethod]),
        iCivGermany: Techs(column=11, exceptions=[iCivilLiberties, iEconomics]),
    }]
...
dTechPreferences = {
    ...
    iCivManchuria: {
        ...
        iGeography: -100,
        iEconomics: -100, 
        iScientificMethod: -100, 
        iReplaceableParts: -80, 
        iPhysics: -80,
        iBallistics: -80, 
        iChemistry: -80, 
        iNationalism: -80	
